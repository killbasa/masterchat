import { b64tou8, concatu8, hextou8, u8tob64, u8tohex } from './util';
...
describe('protobuf util', () => {
	...
	it('can concatenate u8 arrays', () => {
		expect(concatu8([new Uint8Array([0, 255]), new Uint8Array([0, 255]), new Uint8Array([3, 3])])).toEqual(new Uint8Array([0, 255, 0, 255, 3, 3]));
	});
});
